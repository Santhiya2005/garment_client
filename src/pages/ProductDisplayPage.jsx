  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            ...
            <h2 className='font-semibold'>Why shop from Wood Zone Designs? </h2>
            <div>
...
const ProductDisplayPage = () => {
  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            <p className='bg-green-300 w-fit px-2 rounded-full'>Grab It Soon</p>
            <h2 className='text-lg font-semibold lg:text-3xl'>{data.name}</h2>  
            <p className=''>{data.unit}</p> 
            <Divider/>
            <div>
              ...
              <div className='flex items-center gap-2 lg:gap-4'>
                ...
                <div className='my-4'>
  <div className={data.stock === 0 ? 'text-red-500 text-xs' : 'text-green-600 text-xs'}>
    {data.stock === 0 ? 'Out of stock' : `Only ${data.stock} left in stock`}
  </div>
