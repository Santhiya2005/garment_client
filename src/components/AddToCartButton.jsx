...
//         if (!data || !data._id) return; // Prevent errors if data is undefined
...
//     useEffect(() => {
//         if (!data || !cartItem.length) return; // Prevent errors if data is null or cart is empty
...
//         if (!cartItemDetails) return; // Prevent error if cartItemDetails is null
